...
public class ScriptUtils {
     ...
     * @throws Exception if an error occurred while splitting the SQL script
     * @see #splitSqlScript(String, String, List)
     * @see #splitSqlScript(EncodedResource, String, String, String, String, String, List)
     */
    public static void splitSqlScript(String script, char separator, List<String> statements) throws Exception {
     ...
     * @see #splitSqlScript(EncodedResource, String, String, String, String, String, List)
     */
    public static void splitSqlScript(String script, String separator, List<String> statements) throws Exception {
            ...
            if (!inLiteral) {
                if (script.startsWith(separator, i)) {
                    ...
                    if (indexOfCommentEnd > i) {
                        ...
                        throw new Exception(String.format("Missing block comment end delimiter [%s].", blockCommentEndDelimiter));
                    }
                } else if (c == ' ' || c == '\n' || c == '\t') {
     ...
     * @throws Exception if an error occurred while executing the SQL script
     ...
     */
    public static void executeSqlScript(Connection connection, Resource resource) throws Exception {
     ...
     * @see #DEFAULT_BLOCK_COMMENT_END_DELIMITER
     */
    public static void executeSqlScript(Connection connection, EncodedResource resource) throws Exception {
    ...
    public static void executeSqlScript(Connection connection, EncodedResource resource, boolean continueOnError,
                                        ...
                                        String blockCommentEndDelimiter) throws Exception {
        ...
        try {
            ...
            try {
                ...
                throw new Exception(resource.toString(), ex);
            }
            ...
            throw new Exception("Failed to execute database script from resource [" + resource + "]", ex);
        }
    }
}
